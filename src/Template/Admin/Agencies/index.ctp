...
<div class="main_page_content" id="agency_index">
    ...
    <div class="m_datatable m-datatable m-datatable--default m-datatable--brand m-datatable--loaded">
        <table class="m-datatable__table" id="AgenciesTable" style="display: block; min-height: 300px; overflow-x: auto;" width="100%">
            ...
            <tr>
                ...
                <td>
                    <?php
                    echo $this->Form->control('type', array('options' =>$agencyTypes, 'empty' => '-- Select Type --', 'class' => 'form-control form-filter input-sm', 'div' => false, 'label' => false)); ?>
                </td>
                <!--<td>
                    <?php
                ...
                <td>
                    ...
                    <a href="/admin/agencies/index" class="btn btn-primary m-btn m-btn--icon m-btn--icon-only">
