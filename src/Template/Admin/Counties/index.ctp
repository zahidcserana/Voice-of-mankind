    ...
    <div class="row">
        <div class="col-md-8">
            <div style="float: left" class="m_datatable m-datatable m-datatable--default m-datatable--brand m-datatable--loaded">
                <table class="m-datatable__table" id="CountiesTable" style="display: block; min-height: 300px; overflow-x: auto;" width="100%">
        ...
        <div class="col-md-4">
            <div>
                <?php echo $this->Form->create($county, array('name' => 'county-form', 'class' => 'm-form m-form--fit m-form--label-align-right')); ?>
