...
<div class="main_page_content" id="state_index">
    <?php echo $this->Flash->render(); ?>
    ...
    <div class="row">
        <div class="col-md-6">
            <div style="float: left" class="m_datatable m-datatable m-datatable--default m-datatable--brand m-datatable--loaded">
                <table class="m-datatable__table" id="StatesTable" style="display: block; min-height: 300px; overflow-x: auto;" width="100%">
                    <thead class="m-datatable__head">
                    <tr>
                        <th style="width: 15% !important;">Name</th>
                        <th style="width: 5% !important;">Latitude</th>
                        <th style="width: 5% !important;">Longitude</th>
                        <th style="width: 10% !important;">created</th>
        ...
        <div class="col-md-6">
            <div>
                <?php echo $this->Form->create($state, array('name' => 'state-form', 'class' => 'm-form m-form--fit m-form--label-align-right')); ?>
