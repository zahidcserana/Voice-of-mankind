    ...
    <?php foreach ($comments as $comment): ?>
        <div class="ri-cmnt-area">
            <div class="comment-wrap first-comment" id="comment-row-<?php echo $comment->id; ?>">
                <div class="photo">
                    <?php echo $this->Html->image('/img/stories/' . $comment->user_id . '/' . $comment->user->avatar_name, array(
                ...
                <div class="comment-block">
                    ...
                    <div class="bottom-comment">
                        <ul class="list-inline play_navigation">
                            <li><a id="<?php echo $comment->content_type . '_1_' . $comment->id; ?>" href="#"> <i
                                            class="fas fa-thumbs-up"></i>
                                    <span id="like_<?php echo $comment->id?>"><?php echo $comment->total_like; ?></span></a></li>
                            <li><a id="<?php echo $comment->content_type . '_0_' . $comment->id; ?>" href="#"> <i
                                            class="fas fa-thumbs-down"></i>
                                    <span id="dislike_<?php echo $comment->id?>"><?php echo $comment->total_dislike; ?></span></a></li>
                            <li><a id="<?php echo $comment->content_type . '_2_' . $comment->id; ?>" href="#"> Reply</a>
                            </li>
                        </ul>
            ...
            <div class="reply-cmnt-area" id="reply-cmnt-area_<?php echo $comment->id; ?>">
                <?php if (count($comment->children) > 0) { ?>
                    <a id="view-reply-btn_<?php echo $comment->id; ?>" class="view-reply-btn"
                       href="javascript:void(0);">View Reply <i class="fas fa-angle-down"></i></a>
                    <a id="hide-reply-btn_<?php echo $comment->id; ?>" class="hide-reply-btn"
                       href="javascript:void(0);" style="display: none">Hide Reply <i class="fas fa-angle-up"></i></a>
                        ...
                        <?php foreach ($comment->children as $child) { ?>
                            <div class="comment-wrap second-comment">
                                ...
                                <div class="comment-block">
                                    ...
                                    <div class="bottom-comment">
                                        <ul class="list-inline play_navigation">
                                            <li><a id="<?php echo $comment->content_type . '_1_' . $child->id; ?>"
                                                   href="#"> <i class="fas fa-thumbs-up"></i>
                                                    <span id="like_<?php echo $child->id?>"><?php echo $child->total_like; ?></span></a></li>
                                            <li><a id="<?php echo $comment->content_type . '_0_' . $child->id; ?>"
                                                   href="#"> <i
                                                            class="fas fa-thumbs-down"></i>
                                                    <span id="dislike_<?php echo $child->id?>"><?php echo $child->total_dislike; ?></span></a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
