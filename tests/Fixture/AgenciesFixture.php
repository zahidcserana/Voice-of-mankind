...
class AgenciesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'agency_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        'website' => ['type' => 'string', 'length' => 100, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'is_active' => 1,
            'created' => '2018-02-04 13:28:30',
            'modified' => '2018-02-04 13:28:30'
        ],
    ];
}
